...
public final class TestSubClass {
    ...
    static {
        ...
        TEST_VALUES.list = CollectionFactory.listOf("list");
        TEST_VALUES.set = CollectionFactory.setOf("set");
        TEST_VALUES.map = CollectionFactory.mapOf("map", 1);
        ...
        TEST_VALUES.subClassMap = CollectionFactory.mapOf("map", TestSubSubClass.of(19, "19"));
    }
    ...
    public static TestSubClass of(int primInt, String string) {
        ...
        cls.primInt = primInt;
        cls.string = string;
        cls.list = CollectionFactory.listOf(string);
        cls.set = CollectionFactory.setOf(string);
        cls.map = CollectionFactory.mapOf(string, primInt);
        cls.testSubSubClass = TestSubSubClass.of(primInt, string);
        cls.subClassList = CollectionFactory.listOf(
                TestSubSubClass.of(primInt * 100, string)
        );
        cls.subClassSet = CollectionFactory.setOf(
                TestSubSubClass.of(primInt * 101, string)
        );
        cls.subClassMap = CollectionFactory.mapOf(string, TestSubSubClass.of(primInt * 102, string));
        return cls;
    }

    public Map<String, Object> asMap() {
        Map<String, Object> asMap = CollectionFactory.mapOf("primInt", primInt, "string", string);
        asMap.put("list", list);
        asMap.put("set", set);
        asMap.put("map", map);
