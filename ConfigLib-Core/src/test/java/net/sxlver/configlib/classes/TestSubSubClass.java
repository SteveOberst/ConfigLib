...
public final class TestSubSubClass {
    ...
    private List<String> list = CollectionFactory.listOf();
    private Set<String> set = CollectionFactory.setOf();
    private Map<String, Integer> map = CollectionFactory.mapOf();
    ...
    public static TestSubSubClass of(int primInt, String string) {
        ...
        cls.list = CollectionFactory.listOf(concat);
        cls.set = CollectionFactory.setOf(concat);
        cls.map = CollectionFactory.mapOf(concat, primInt);
        return cls;
    }
