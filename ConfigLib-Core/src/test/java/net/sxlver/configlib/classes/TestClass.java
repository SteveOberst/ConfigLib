package net.sxlver.configlib.classes;

import net.sxlver.configlib.annotation.Comment;
import net.sxlver.configlib.annotation.Convert;
...
import static net.sxlver.configlib.util.CollectionFactory.*;
...
public final class TestClass extends YamlConfiguration {
    ...
    static {
        ...
        TEST_VALUES.ints = CollectionFactory.setOf(1, 2, 3);
        TEST_VALUES.strings = CollectionFactory.listOf("a", "b", "c");
        TEST_VALUES.doubleByBool = CollectionFactory.mapOf(true, 1.0, false, 2.0);
        /* containers of other types */
        TEST_VALUES.subClassSet = CollectionFactory.setOf(
                TestSubClass.of(1, "1"),
                TestSubClass.of(2, "2")
        );
        TEST_VALUES.subClassList = CollectionFactory.listOf(
                TestSubClass.of(3, "3"),
                TestSubClass.of(4, "4")
        );
        TEST_VALUES.subClassMap = CollectionFactory.mapOf(
                "5", TestSubClass.of(5, "5"),
                "6", TestSubClass.of(6, "6")
        );
        /* nested containers of simple types */
        TEST_VALUES.listsList = CollectionFactory.listOf(
                CollectionFactory.listOf(1, 2), CollectionFactory.listOf(3, 4)
        );
        TEST_VALUES.setsSet = CollectionFactory.setOf(
                CollectionFactory.setOf("a", "b"), CollectionFactory.setOf("c", "d")
        );
        TEST_VALUES.mapsMap = CollectionFactory.mapOf(
                1, CollectionFactory.mapOf("1", 1), 2, CollectionFactory.mapOf("2", 2)
        );
        /* nested containers of custom types */
        TEST_VALUES.subClassListsList = listOf(
                CollectionFactory.listOf(TestSubClass.of(7, "7"), TestSubClass.of(8, "8"))
        );
        TEST_VALUES.subClassSetsSet = setOf(CollectionFactory.setOf(
                TestSubClass.of(9, "9"), TestSubClass.of(10, "10")
        ));
        TEST_VALUES.subClassMapsMap = CollectionFactory.mapOf(
        ...
        TEST_VALUES.enums = CollectionFactory.listOf(TestEnum.DEFAULT, TestEnum.NON_DEFAULT);
