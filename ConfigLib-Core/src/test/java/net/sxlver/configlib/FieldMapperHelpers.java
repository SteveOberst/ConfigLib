...
import static net.sxlver.configlib.configs.yaml.YamlConfiguration.YamlProperties.DEFAULT;
...
public class FieldMapperHelpers {
    ...
    public static Map<String, Object> instanceToMap(
        ...
        FieldMapper.MappingInfo mappingInfo = new FieldMapper.MappingInfo(null, props);
